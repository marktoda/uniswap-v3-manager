...
interface UniswapV3PositionsInterface extends ethers.utils.Interface {
  functions: {
...
export class UniswapV3Positions extends BaseContract {
  ...
  interface: UniswapV3PositionsInterface;
  ...
  estimateGas: {
    ...
    burn(tokenId: BigNumberish, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<BigNumber>;
