...
export class UniswapV3Positions__factory {
  static readonly abi = _abi;
  static createInterface(): UniswapV3PositionsInterface {
    return new utils.Interface(_abi) as UniswapV3PositionsInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): UniswapV3Positions {
    return new Contract(address, _abi, signerOrProvider) as UniswapV3Positions;
  }
}
